...
function run()
    ...
    println("A new vector: ", toString(a))
    ...
    println("a - b = ", toString(a-b))
    println("a * b = ", toString(a*b))
    println("y * a = ", toString(y*a))
    println("a / y = ", toString(a/y))
    println("||b|| = ", toString(norm(b)))
    println("Base vectors:")
    e1 = unitVector(a)
    e2 = unitVector(b)
    println("e1    = ", toString(e1))
    println("e2    = ", toString(e2))
    e3 = cross(e1, e2)
    println("e3    = ", toString(e3), "  where e3 = e1 × e2")
    println("e1.e2 = ", toString(e1*e2), "  angle is obtuse")
    println("e1.e3 = ", toString(e1*e3), "  angle is right")
    println("e2.e3 = ", toString(e2*e3), "  angle is right")
    println()
